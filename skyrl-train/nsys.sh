...
OUT_DIR=/local_nvme1/mborjigi/output/$1
SCRIPT=./examples/text_to_sql/run_skyrl_sql_fast_debug_1gpu.sh
SCRIPT=./examples/text_to_sql/run_skyrl_sql_fast_debug_3b_4gpu.sh
SCRIPT=./examples/text_to_sql/run_skyrl_sql_fast_debug_7b_4gpu.sh
SCRIPT=./examples/mini_swe_agent/run_mini_swe_8B.sh
SCRIPT=./examples/mini_swe_agent/run_mini_swe_30B.sh
SCRIPT=./examples/text_to_sql/run_skyrl_sql.sh
# SCRIPT=./examples/gsm8k/run_gsm8k.sh

rm -rf $OUT_DIR
mkdir $OUT_DIR
mkdir -p /local_nvme1/mborjigi/output/aux_logs
...
mv /local_nvme1/mborjigi/output/aux_logs "$OUT_DIR/"

mv /local_nvme1/mborjigi/output/*.json* "$OUT_DIR/"
